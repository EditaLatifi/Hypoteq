...
export default function Header() {
  ...
  return (
    ...
    >
      ...
      {menuOpen && (
        <div className="absolute left-0 top-full w-full max-h-[calc(100dvh-70px)] md:max-h-[calc(100dvh-85px)] overflow-y-auto overscroll-contain bg-white shadow-2xl border-t border-[#CAF476] z-40 animate-fadeIn">
