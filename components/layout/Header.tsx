    ...
    >
      ...
      {menuOpen && (
        <div className="absolute left-0 top-full w-full bg-white shadow-2xl border-t border-[#CAF476] z-40 animate-fadeIn">
          ...
          <div className="w-full flex flex-col sm:flex-row sm:flex-wrap justify-center items-center gap-3 sm:gap-6 px-5 py-4 border-t border-[#CAF476]">
            ...
            <Link href={`/${pathLocale}/funnel`} className="w-full sm:w-auto max-w-[340px] flex items-center justify-center gap-2 px-6 py-3 rounded-[58px] bg-[#CAF476] text-[#132219] text-lg font-semibold hover:opacity-90 transition">
              {t("navigation.hypothekAnfragen")}
            </Link>
            <a
