...
>
        ...
        <div
          ...
          "
        >
          <RateCard title={t("bestChoices.saronFrom")} value="0.85%" />
          <RateCard title={t("bestChoices.fiveYearsFrom")} value="1.30%" />
          <RateCard title={t("bestChoices.tenYearsFrom")} value="1.60%" />
        </div>
